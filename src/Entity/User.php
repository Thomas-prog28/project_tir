...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setSiteRole(string $role): static
    {
        $this->siteRole = $role;
    ...
    public function setPictureFile(?File $pictureFile = null): void
    {
        ...
        if (null !== $pictureFile) {
            // Force Doctrine à détecter un changement, indispensable pour que Vich déclenche l'upload
    ...
    //gestion du retrait du badge "inacessible" de easyAdmin quand aucun #licence est renseigné
    public function getLicenceNumberDisplay(): string
    {
        return $this->member?->getLicenceNumber() ?? '';
    }
